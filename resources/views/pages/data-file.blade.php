...
<style>
    ...
    body {
        ...
        /* Sembunyikan kursor ketik pada teks biasa */
    }
    ...
    [contenteditable] {
        caret-color: auto;
        /* Kembalikan kursor ketik pada input */
    }
                        ...
                        <tr draggable="true" data-doc-id="{{ $doc->id }}" data-is-folder="{{ $doc->is_folder ? 'true' : 'false' }}" class="document-row {{ $doc->is_folder ? 'folder-row' : '' }}">
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    $officePath = 'file://' . $host . '/File_documents/' . $doc->filename;
                                    }
                                    ...
                                    <a href="{{ url('data-File/download/'.$doc->id) }}" class="action-btn-modern btn-hover-success" title="Download Dokumen"><i class="bi bi-cloud-arrow-down-fill"></i></a>
                                    @else
                                    ...
                                    <form action="{{ url('data-File/'.$doc->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus dokumen ini secara permanen?');">
                                        @csrf
                                        @method('DELETE')
...
<div class="modal fade" id="uploadModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-glass border-0">
            ...
            <form action="{{ url('data-File/upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
